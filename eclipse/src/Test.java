...
public class Test {
	...
	public static void main(String[] args) {
		...
		Software andro2sw = new Software_Gesellschafter_Stufe1();
		...
		Software andro3sw = new Software_Bauarbeiter_Stufe3();
		...
		Software andro4sw = new Software_Servicetechniker_Stufe4();
		...
		Software andro6sw = new Software_Objektbewacher_Stufe4();
		...
		Software andro7sw = new Software_Leibwaechter_Stufe4();
		...
		Software andro8sw = new Software_Kaempfer_Stufe5();
